...
public interface Constants {
	...
	final String DELAYMATRIX_FILE = "resources/config/delaymatrix.xml";
	final String BWMATRIX_FILE = "resources/config/bwmatrix.xml";
	...
	final String BROKER_POLICY_CS = "Cuckoo Search Optimization";
	final String BROKER_POLICY_HYBRID = "Hybrid Optimization";
